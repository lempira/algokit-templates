...
By default the template creates a single `HelloWorld` contract under mycontract folder in the `smart_contracts` directory. To add a new contract:
...
2. Each contract potentially has different creation parameters and deployment steps. Hence, you need to define your deployment logic in file.
